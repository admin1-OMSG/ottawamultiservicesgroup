...
const futureNavigation: { label: string; icon: typeof Package }[] = []
...
export function Sidebar() {
  ...
  return <aside className="flex min-h-screen w-64 flex-col border-r border-slate-200 bg-slate-950 text-white">
    <div className="border-b border-slate-800 px-6 py-6"><p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400">Ottawa Multiservices</p><h1 className="mt-2 text-xl font-bold">Admin CRM</h1><p className="mt-1 text-sm text-slate-400">Version 1.5</p></div>
