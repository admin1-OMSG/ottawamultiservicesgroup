...
function CustomerPortal() {
  ...
  async function logout() {
    ...
    setCustomer(null); setEstimates([]); setInvoices([]); setJobs([]); setSignatures({}); setBookings({}); setLoggedIn(false)
  }
