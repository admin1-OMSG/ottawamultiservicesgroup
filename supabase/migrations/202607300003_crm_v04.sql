...
drop policy if exists "Active admins can manage invoices"
on public.invoices;

create policy "Active admins can manage invoices"
on public.invoices
for all
to authenticated
using (
...
drop policy if exists "Active admins can manage invoice items"
on public.invoice_items;

create policy "Active admins can manage invoice items"
on public.invoice_items
for all
to authenticated
using (
...
drop policy if exists "Active admins can manage payments"
on public.payments;
