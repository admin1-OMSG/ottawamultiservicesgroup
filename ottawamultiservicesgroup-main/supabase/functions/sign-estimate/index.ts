...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const consentText = "I confirm that I reviewed and accept this estimate, its estimated duration, prices and terms. My signature and appointment reservation are a commitment to proceed with the service and to pay the invoice under the agreed terms. Additional work outside the agreed scope requires my prior approval."
