...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Conditions | Ottawa Multi Services Group" },
      { name: "description", content: "Terms & conditions for using Ottawa Multi Services Group services and website." },
      { property: "og:title", content: "Terms & Conditions — Ottawa MSG" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-3xl px-6 prose prose-slate max-w-none">
          ...
          <p className="mt-3 text-foreground/90">Quotes are estimates based on the information you provide. Final pricing may be adjusted after an on-site assessment. Bookings are confirmed once you receive written confirmation from our team.</p>
